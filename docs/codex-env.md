...
- `.codex/config.toml` should whitelist only the normal local-work env names: `GOOGLE_API_KEY`, `OPENFDA_API_KEY`, `RESEND_API_KEY`, `CONTACT_EMAIL`, `CONTACT_FROM_EMAIL`
...
- OpenFDA and contact flow: `OPENFDA_API_KEY`, `RESEND_API_KEY`, `CONTACT_EMAIL`, `CONTACT_FROM_EMAIL`
