...
export function SiteFooter() {
  ...
  return (
    <footer className="w-full border-t border-[#ebe8df] bg-[#f8f7f2]">
      <FooterEntry className="site-shell py-9 sm:py-10">
        <div className="grid gap-6 lg:grid-cols-[minmax(18rem,24rem)_minmax(0,1fr)] lg:items-start lg:gap-8">
          <div className="max-w-[23rem]">
            <SiteBrand
              className="mb-3"
              wordmarkClassName="text-[1.72rem] font-medium tracking-tight"
            />
            <p className="max-w-[22.5rem] text-[0.94rem] leading-6 text-[#666666]">
              Nearby pharmacy search with medication-access information and
              clear guidance on what still needs verification.
            </p>
          </div>

          <div className="grid gap-7 sm:grid-cols-3 sm:gap-x-7 sm:gap-y-8 lg:gap-x-8">
        ...
        <div className="mt-6 border-t border-[#e5e5e5] pt-5 sm:mt-7 sm:pt-6">
