...
const methodologyGuide = [
  {
    ...
    detail:
      "Medication typeahead hits a normalized FDA-backed index plus a clearly isolated fictional medication catalog, while location stays constrained to the handled city and ZIP-backed entries in this build.",
  },
  {
